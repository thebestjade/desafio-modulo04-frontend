...
function CreateCharge() {
  ...
  async function addCharge(addData) {
    let newValue = addData.valor;
    newValue = newValue.replace(/R\$ /g, "");
    const newAddData = { ...addData, valor: newValue };
    ...
    try {
      ...
      const response = await fetch(
        "https://desafio04-backend.herokuapp.com/cadastrarCobranca",
        {
          method: "POST",
          cache: "no-cache",
    ...
    <div className="container-client flex-row">
      ...
      <div className="container-form-client flex-column overflow-scroll">
        ...
        <form
          ...
          onSubmit={handleSubmit(addCharge)}
          onKeyDown={(e) =>
