                        ...
                        <ChargesProvider>
                            <ClientsProvider>
                                <ProtectedRoutes>
                                    ...
                                    <Route path="/criarCobranca" exact component={RegisterCharge} />
                                    <Route path='/adicionarCliente' exact component={RegisterClient} />
                                    ...
                                    <Route path="/clientes/:clienteId" exact component={EditClient} />
                                </ProtectedRoutes>
                            </ClientsProvider>
                        </ChargesProvider>
                        <RedirectToHome>
