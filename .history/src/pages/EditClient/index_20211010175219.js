...
function EditClient(id) {
    ...
    async function GetClients() {
        ...
        const response = await fetch(`https://desafio04-backend.herokuapp.com/clientes/${id}`, {
            headers: {
    ...
    async function updateClient(updateData) {
        ...
        try {
            ...
            const response = await fetch(`https://desafio04-backend.herokuapp.com/editarCliente/${id}`, {
                method: "PUT",
                mode: "cors",
                cache: "no-cache",
