...
function EditCharge({ idCharge, setIdCharge, setIsOpenCharge }) {
  ...
  async function getCharge() {
    ...
    const response = await fetch(
      `https://desafio04-backend.herokuapp.com/chargees/${idCharge}`,
      {
        mode: "cors",
        headers: {
  ...
  async function updateCharge(updateData) {
    ...
    try {
      ...
      const response = await fetch(
        `https://desafio04-backend.herokuapp.com/editarCharge/${idCharge}`,
        {
          method: "PUT",
          mode: "cors",
          cache: "no-cache",
            ...
            >
                    <div className='flex-column  content-center items-center'>
                        <div className='flex-column'>
                            <label htmlFor='name'>Charge</label>                          <select
